...
(12347678021, 'MODERATOR'),
(22342678031, 'ADMIN'),
(32341678061, 'STAFF'),
(42346678041, 'CUSTOMER'),
(52340678081, 'GUEST');

INSERT INTO users_entity(id, name, username, password, created_at, created_by) VALUES
...
INSERT INTO users_entity_roles(users_entity_id, roles_id) VALUES
(1235654784521, 12347678021),
(2354478854412, 22342678031),
(1023445234789, 32341678061),
(1215489523654, 42346678041),
(9123654785922, 52340678081);
